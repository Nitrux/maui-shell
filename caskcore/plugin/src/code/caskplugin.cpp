...
void CaskCorePlugin::registerTypes(const char *uri)
{
...
QUrl CaskCorePlugin::componentUrl(const QString &fileName) const
{
    return QUrl(resolveFileUrl(fileName));
}

void CaskCorePlugin::initializeEngine(QQmlEngine *engine, const char *uri)
{
    Q_UNUSED(engine)
    Q_UNUSED(uri)
}

#include "caskplugin.moc"
#include "moc_caskplugin.cpp"
